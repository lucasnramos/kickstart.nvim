...
vim.o.statusline = '%t %m %r %=%-14.(%l,%c%V%)'
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set({ 'n', 'v', 'x' }, '<leader>st', builtin.builtin, { desc = '[S]earch Select [T]elescope' })
      vim.keymap.set('n', '<leader>ss', builtin.git_status, { desc = '[S]earch Git Status' })
      vim.keymap.set({ 'n', 'v', 'x' }, '<leader>sw', builtin.grep_string, { desc = '[S]earch Selection' })
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('gre', vim.diagnostic.open_float, 'Show Error')
